...
def go(args):
    ...
    # Get the local path of artifact
    ...
    mlflow.sklearn.save_model(sk_pipe, path="random_forest_dir", input_example=X_train)

    # Upload the model we just exported to W&B
    artifact = wandb.Artifact(name=args.output_artifact, type="model_export", description="Random Forest Model",
